    ...
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="glass rounded-xl p-8 space-y-6">
          <h1 className="font-heading text-2xl italic text-creme text-center">Créer un compte</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Label htmlFor="name" className="text-perle/60 text-sm font-light">Nom</Label>
              <Input
                id="name"
                type="text"
                value={name}
            ...
            >
              ...
              <span className="relative z-10">{loading ? "Création..." : "Créer mon compte"}</span>
            </Button>
          </form>

          <p className="text-center text-sm text-perle/40 font-light">
            Déjà un compte ?{" "}
            <Link href="/auth/login" className="text-or hover:underline">
              Se connecter
            </Link>
          </p>
        </div>
